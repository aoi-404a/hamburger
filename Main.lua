...
-- Add egg details for tooltips
local eggDetails = {
    ["Dinosaur Egg"] = "A rare egg with dinosaur pets.",
    ["Dragon Egg"] = "Contains a dragon pet.",
    ["Phoenix Egg"] = "Contains a phoenix pet."
}

-- Remove all previous MouseButton1Click connections for gear, egg, and seed dropdown buttons
-- Only use the following connections for dropdowns:
...
-- Remove old dropdown button event connections (for gear, egg, seed)
-- Patch all three dropdowns to use openDropdown with details
gearDropdownBtn.MouseButton1Click:Connect(function()
    openDropdown(gearDropdownList, gearOptions, selectedGear, setDropdownHeight, function()
        autoBuyGearToggle.Position = UDim2.new(0, 20, 0, gearDropdownList.Position.Y.Offset + gearDropdownList.Size.Y.Offset + 6)
        eggHeader.Position = UDim2.new(0, 20, 0, autoBuyGearToggle.Position.Y.Offset + autoBuyGearToggle.Size.Y.Offset + 12)
