...
-- Patch button events to use new openDropdown (and always reposition all UI below)
local function repositionAllShopUI()
...
seedDropdownBtn.MouseButton1Click:Connect(function()
    openDropdown(seedDropdownList, seedOptions, selectedSeeds, setDropdownHeight, repositionAllShopUI)
end)
...
-- Dropdown open/close logic for all three dropdowns (keep only this definition)
